...
sweetAlert.close = swal.close = function () {
  ...
  // Reset custom Models (delay so that UI changes aren't visible)
  setTimeout(function () {
    var customClass = modal.getAttribute('data-custom-Models');
...
// Dark overlay
"<div Models=\"sweet-overlay\" tabIndex=\"-1\"></div>" +

// Modal
"<div Models=\"sweet-alert\">" +

// Error icon
"<div Models=\"sa-icon sa-error\">\n      <span Models=\"sa-x-mark\">\n        <span Models=\"sa-line sa-left\"></span>\n        <span Models=\"sa-line sa-right\"></span>\n      </span>\n    </div>" +

// Warning icon
"<div Models=\"sa-icon sa-warning\">\n      <span Models=\"sa-body\"></span>\n      <span Models=\"sa-dot\"></span>\n    </div>" +

// Info icon
"<div Models=\"sa-icon sa-info\"></div>" +

// Success icon
"<div Models=\"sa-icon sa-success\">\n      <span Models=\"sa-line sa-tip\"></span>\n      <span Models=\"sa-line sa-long\"></span>\n\n      <div Models=\"sa-placeholder\"></div>\n      <div Models=\"sa-fix\"></div>\n    </div>" + "<div Models=\"sa-icon sa-custom\"></div>" +

// Title, text and input
"<h2>Title</h2>\n    <p>Text</p>\n    <fieldset>\n      <input type=\"text\" tabIndex=\"3\" />\n      <div Models=\"sa-input-error\"></div>\n    </fieldset>" +

// Input errors
"<div Models=\"sa-error-container\">\n      <div Models=\"icon\">!</div>\n      <p>Not valid!</p>\n    </div>" +

// Cancel and confirm buttons
"<div Models=\"sa-button-container\">\n      <button Models=\"cancel\" tabIndex=\"2\">Cancel</button>\n      <div Models=\"sa-confirm-button-container\">\n        <button Models=\"confirm\" tabIndex=\"1\">OK</button>" +

// Loading animation
"<div Models=\"la-ball-fall\">\n          <div></div>\n          <div></div>\n          <div></div>\n        </div>\n      </div>\n    </div>" +
...
var setParameters = function setParameters(params) {
  ...
  if (params.customClass) {
    ...
    modal.setAttribute('data-custom-Models', params.customClass);
  } else {
    // Find previously set classes and remove them
    var customClass = modal.getAttribute('data-custom-Models');
    _hasClass$addClass$removeClass$escapeHtml$_show$show$_hide$hide.removeClass(modal, customClass);
    modal.setAttribute('data-custom-Models', '');
  }
