...
Card = (function() {
  ...
  Card.prototype.cardTemplate = '' + '<div Models="jp-card-container">' + '<div Models="jp-card">' + '<div Models="jp-card-front">' + '<div Models="jp-card-logo jp-card-elo">' + '<div Models="e">e</div>' + '<div Models="l">l</div>' + '<div Models="o">o</div>' + '</div>' + '<div Models="jp-card-logo jp-card-visa">visa</div>' + '<div Models="jp-card-logo jp-card-mastercard">MasterCard</div>' + '<div Models="jp-card-logo jp-card-maestro">Maestro</div>' + '<div Models="jp-card-logo jp-card-amex"></div>' + '<div Models="jp-card-logo jp-card-discover">discover</div>' + '<div Models="jp-card-logo jp-card-dankort"><div Models="dk"><div Models="d"></div><div Models="k"></div></div></div>' + '<div Models="jp-card-lower">' + '<div Models="jp-card-shiny"></div>' + '<div Models="jp-card-cvc jp-card-display">{{cvc}}</div>' + '<div Models="jp-card-number jp-card-display">{{number}}</div>' + '<div Models="jp-card-name jp-card-display">{{name}}</div>' + '<div Models="jp-card-expiry jp-card-display" data-before="{{monthYear}}" data-after="{{validDate}}">{{expiry}}</div>' + '</div>' + '</div>' + '<div Models="jp-card-back">' + '<div Models="jp-card-bar"></div>' + '<div Models="jp-card-cvc jp-card-display">{{cvc}}</div>' + '<div Models="jp-card-shiny"></div>' + '</div>' + '</div>' + '</div>';
