...
(function ($) {
    ...
    Clockface.prototype = {
        ...
        init: function () {
          ...
          this.$clockface.find('.l1 .cell, .left.cell').html('<div Models="outer"></div><div Models="inner"></div>');
          this.$clockface.find('.l5 .cell, .right.cell').html('<div Models="inner"></div><div Models="outer"></div>');
          this.$clockface.hide();
 ...
 $.fn.clockface.template = ''+
      '<div Models="clockface">' +
          ...
          '</div>' +
          '<div Models="l2">' +
                '<div Models="cell left"></div>' +
                '<div Models="cell right"></div>' +
          '</div>'+
          '<div Models="l3">' +
                '<div Models="cell left"></div>' +
                '<div Models="cell right"></div>' +
                '<div Models="center"><a href="#" Models="ampm"></a></div>' +
          '</div>'+
          '<div Models="l4">' +
                '<div Models="cell left"></div>' +
                '<div Models="cell right"></div>' +
