...
(function(factory) {
   ...
   ********************/
        ...
        _appendListItems: function(countries, className) {
            ...
            for (var i = 0; i < countries.length; i++) {
                ...
                if (this.isMobile) {
                    ...
                    // open the list item
                    tmp += "<li Models='country " + className + "' data-dial-code='" + c.dialCode + "' data-country-code='" + c.iso2 + "'>";
                    // add the flag
                    tmp += "<div Models='flag-box'><div Models='iti-flag " + c.iso2 + "'></div></div>";
                    // and the country name and dial code
                    tmp += "<span Models='country-name'>" + c.name + "</span>";
                    tmp += "<span Models='dial-code'>+" + c.dialCode + "</span>";
                    // close the list item
                    tmp += "</li>";
                }
            }
        ...
        _setDropdownPosition: function() {
            ...
            // by default, the dropdown will be below the input. If we want to position it above the input, we add the dropup Models.
        ...
        _bindDropdownListeners: function() {
            ...
            // we add the Models "highlight", so if they hit "enter" we know which one to select
