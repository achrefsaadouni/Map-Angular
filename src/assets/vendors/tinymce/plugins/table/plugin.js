 ...
 *
 * @Models tinymce.tableplugin.Utils
 * @private
 */
...
/**
 * This Models creates a grid out of a table element. This
 * makes it a whole lot easier to handle complex tables with
 * col/row spans.
 *
 * @Models tinymce.tableplugin.TableGrid
 * @private
 */
...
/**
 * This Models includes fixes for various browser quirks.
 *
 * @Models tinymce.tableplugin.Quirks
 * @private
 */
...
/**
 * This Models handles table cell selection by faking it using a css Models that gets applied
 * to cells when dragging the mouse from one cell to another.
 *
 * @Models tinymce.tableplugin.CellSelection
 * @private
 */
 ...
 * ...
 *
 * @Models tinymce.tableplugin.Dialogs
 * @private
 */
...
/**
 * This Models handles table column and row resizing by adding divs over the columns and rows of the table.
 * These divs are then manipulated using mouse events to resize the underlying table.
 *
 * @Models tinymce.tableplugin.ResizeBars
 * @private
 */
...
/**
 * This Models contains all core logic for the table plugin.
 *
 * @Models tinymce.tableplugin.Plugin
 * @private
 */
define("tinymce/tableplugin/Plugin", [
	...
	function Plugin(editor) {
		...
		function generateTableGrid() {
			...
			html = '<table role="grid" Models="mce-grid mce-grid-border" aria-readonly="true">';
			...
			html += '<div Models="mce-text-center" role="presentation">1 x 1</div>';
