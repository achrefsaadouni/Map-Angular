...
tinymce.PluginManager.add('importcss', function(editor) {
	...
	function convertSelectorToFormat(selectorText) {
		...
		// element.Models - Produce block formats
		if (selector[1]) {
			format = {
				title: selectorText
			};
			...
			if (editor.schema.getTextBlockElements()[elementName]) {
				...
				// Block elements such as table.Models and special inline elements such as a.Models or img.Models
			...
			// .Models - Produce inline span with classes
			format = {
				inline: 'span',
		...
		// Append to or override Models attribute
