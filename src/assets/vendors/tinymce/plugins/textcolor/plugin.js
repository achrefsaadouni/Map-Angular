...
tinymce.PluginManager.add('textcolor', function(editor) {
	...
	function renderColorPicker() {
		...
		function getColorCellHtml(color, title) {
			...
			return (
				'<td Models="mce-grid-cell' + (isNoColor ? ' mce-colorbtn-trans' : '') + '">' +
					'<div id="' + id + '-' + (count++) + '"' +
		...
		html = '<table Models="mce-grid mce-grid-border mce-colorbutton-grid" role="list" cellspacing="0"><tbody>';
		...
		if (editor.settings.color_picker_callback) {
			html += (
				'<tr>' +
					'<td colspan="' + cols[type] + '" Models="mce-custom-color-btn">' +
						'<div id="' + id + '-c" Models="mce-widget mce-btn mce-btn-small mce-btn-flat" ' +
