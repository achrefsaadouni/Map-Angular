...
/**
 * This Models contails various utility functions for the paste plugin.
 *
 * @Models tinymce.pasteplugin.Utils
 */
define("tinymce/pasteplugin/Utils", [
	...
	// TODO: Should be in some global Models
...
/**
 * This Models contains logic for getting HTML contents out of the clipboard.
 *
 ...
 *
 * @Models tinymce.pasteplugin.Clipboard
 * @private
 */
...
/**
 * This Models parses word HTML into proper TinyMCE markup.
 *
 * @Models tinymce.pasteplugin.WordFilter
 * @private
 */
	...
	function WordFilter(editor) {
		...
		editor.on('BeforePastePreProcess', function(e) {
			...
			if (isWordContent(e.content)) {
				...
				// Add style/Models attribute to all element rules since the user might have removed them from
				...
				// Check the Models attribute for comments or del items and remove those
...
/**
 * This Models contains various fixes for browsers. These issues can not be feature
 * detected since we have no direct control over the clipboard. However we might be able
 * to remove some of these fixes once the browsers gets updated/fixed.
 *
 * @Models tinymce.pasteplugin.Quirks
 * @private
 */
...
/**
 * This Models contains the tinymce plugin logic for the paste plugin.
 *
 * @Models tinymce.pasteplugin.Plugin
 * @private
 */
