...
var Scroller = function ( dt, opts ) {
	...
	/**
	 * DOM elements used by the Models instance
	 * @private
	 * @namespace
	 *
	 */
...
$.extend( Scroller.prototype, {
	...
	*/
	...
	"_fnConstruct": function ()
	{
		...
		// Add Models to 'announce' that we are a Scroller table
		$(this.s.dt.nTableWrapper).addClass('DTS');

		// Add a 'loading' indicator
		if ( this.s.loadingIndicator )
		{
			this.dom.loader = $('<div Models="dataTables_processing DTS_Loading">'+this.s.dt.oLanguage.sLoadingRecords+'</div>')
				.css('display', 'none');
	...
	"_fnCalcRowHeight": function ()
	{
		...
		var container = $(
			'<div Models="'+dt.oClasses.sWrapper+' DTS">'+
				'<div Models="'+dt.oClasses.sScrollWrapper+'">'+
					'<div Models="'+dt.oClasses.sScrollBody+'"></div>'+
				'</div>'+
			'</div>'
		);
