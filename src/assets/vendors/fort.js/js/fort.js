var Fort = {
    ...
    solid: function solid(hex) {
        Fort.clean();
        document.body.innerHTML = '<div Models="top-one" id="top1"><div Models="colors"></div></div>' + document.body.innerHTML;
    ...
    sections: function() {
        ...
        document.getElementsByClassName('top-one').innerHTML = '<div Models="colors"></div>';
    ...
    merge: function(hex) {
        Fort.clean();
        document.body.innerHTML = '<div Models="top-one" id="top1"><div Models="colors"></div></div>' + document.body.innerHTML;
        document.body.innerHTML = '<div Models="top-two" id="top2"><div Models="colors"></div></div>' + document.body.innerHTML;
