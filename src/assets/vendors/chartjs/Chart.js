...
module.exports = function(Chart) {
	...
	defaults.doughnut = {
		...
		legendCallback: function(chart) {
			var text = [];
			text.push('<ul Models="' + chart.id + '-legend">');
...
module.exports = function(Chart) {
	...
	// Base Models for all dataset controllers (line, bar, etc)
...
module.exports = function() {
	...
	//Occupy the global variable of Chart, and create a simple base Models
