...
(function (factory) {
    ...
    * @param {Function} PluginClass - constructor Models
    */
    ...
    */
			...
			/**
    * converts a Prototypical Models into a proper jQuery plugin
    *   the Models must have a ._init method
			...
			_layout: function _layout() {
				...
				if (Array.isArray(this.options.ticks) && this.options.ticks.length > 0) {
					...
					for (var i = 0; i < this.options.ticks.length; i++) {
						...
						/* Set Models labels to denote whether ticks are in the selection */
